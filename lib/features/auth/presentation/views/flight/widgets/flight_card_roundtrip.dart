...
class FlightCardRoundTrip extends StatelessWidget {
  ...
  Widget build(BuildContext context) {
    ...
    final arrivalTimeInTime = CustomFormatters.hourAndMinute.format(arrivalTime);

    final returnDepartureTimeInDate = CustomFormatters.monthDateYear.format(returnDepartureTime);
    final returnDepartureTimeInTime = CustomFormatters.hourAndMinute.format(returnDepartureTime);
    final returnArrivalTimeInTime = CustomFormatters.hourAndMinute.format(returnArrivalTime);
